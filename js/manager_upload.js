function subir_documento(){
  ...
  $.ajax({
    ...
    success: function(resultado){
      ...
      resultado_curp = a['resultado_curp'].toString();
      resultado_acta = a['resultado_acta'].toString();
      resultado_constancia = a['resultado_constancia'].toString();
      resultado_pago = a['resultado_pago'].toString();
      resultado_domicilio = a['resultado_domicilio'].toString();
